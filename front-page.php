...
<div id="primary" class="content-area">
    <main id="main" class="site-main">
            ...
            <div class="container">
                ...
                <div class="about-content">
                    <div class="about-text">
                        <p><strong>思い出広場</strong>は、千葉県市原市五井駅から徒歩4分にある<strong>レトロトイ専門店</strong>です。昭和から平成初期のおもちゃや雑誌、フィギュアなど、懐かしいアイテムを豊富に取り扱っています。</p>
        ...
        <section class="access-section">
            <div class="container">
                <h2>思い出広場へのアクセス | 市原市五井駅から徒歩4分</h2>
